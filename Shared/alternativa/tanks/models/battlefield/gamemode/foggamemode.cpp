...
void FogGameMode::applyChanges(BattleView3D *viewport)
{
...
void FogGameMode::applyChangesBeforeSettings(IBattleSettings *settings)
{
	...
	{
		this->camera->directionalLight->intensity = 1.1;
...
BitmapData* FogGameMode::applyColorchangesToSkybox(BitmapData *skybox)
{
	(void)skybox;
